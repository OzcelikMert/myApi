...
export default function (fastify: FastifyInstance, opts: any, done: () => void) {
    ...
    fastify.get('/get/:_id', { preHandler: [requestMiddleware.check(postSchema.getOne)] }, postController.getOne);
    ...
    fastify.put('/update/:_id', { preHandler: [requestMiddleware.check(postSchema.putOne), sessionMiddleware.check, permissionMiddleware.check, postMiddleware.checkOne, postMiddleware.checkUrl] }, postController.updateOne);
