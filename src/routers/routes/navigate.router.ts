...
navigateRouter.route(`/`)
    ...
    .put([requestMiddleware.check(navigateSchema.putStatus), sessionMiddleware.check, permissionMiddleware.check], navigateController.updateStatus)
    .delete([requestMiddleware.check(navigateSchema.delete), sessionMiddleware.check, permissionMiddleware.check], navigateController.delete)
