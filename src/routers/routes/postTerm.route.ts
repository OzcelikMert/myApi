...
export default function (fastify: FastifyInstance, opts: any, done: () => void) {
    fastify.get('/get/:_id', { preHandler: [requestMiddleware.check(postTermSchema.getOne)] }, postTermController.getOne);
    ...
    fastify.put('/update/rank/:_id', { preHandler: [requestMiddleware.check(postTermSchema.putOneRank), sessionMiddleware.check, permissionMiddleware.check, postTermMiddleware.checkOne] }, postTermController.updateOneRank);
    ...
    fastify.put('/update/:_id', { preHandler: [requestMiddleware.check(postTermSchema.putOne), sessionMiddleware.check, permissionMiddleware.check, postTermMiddleware.checkOne, postTermMiddleware.checkUrl] }, postTermController.updateOne);
