...
export default function (fastify: FastifyInstance, opts: any, done: () => void) {
    ...
    fastify.get('/get/:_id', { preHandler: [requestMiddleware.check(navigationSchema.getOne)] }, navigationController.getOne);
    ...
    fastify.put('/update/rank/:_id', { preHandler: [requestMiddleware.check(navigationSchema.putOneRank), sessionMiddleware.check, permissionMiddleware.check, navigationMiddleware.checkOne] }, navigationController.updateOneRank);
    ...
    fastify.put('/update/:_id', { preHandler: [requestMiddleware.check(navigationSchema.putOne), sessionMiddleware.check, permissionMiddleware.check, navigationMiddleware.checkOne] }, navigationController.updateOne);
